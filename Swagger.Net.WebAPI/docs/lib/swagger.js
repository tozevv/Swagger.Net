...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.models = null;
    ...
    SwaggerApi.prototype.selfReflect = function() {
      ...
      SwaggerApi.prototype.models = this.setConsolidatedModels();
      this.ready = true;
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      if ((resourceObj.apis != null) && (this.api.resourcePath != null)) {
        ...
        obj = {
          ...
          on: {
            error: function(error) {
              if( error._raw.statusCode == 401)
                return _this.api.fail("Unable to list operations. Check api key");
              else
  ...
  SwaggerModel = (function() {
    ...
    SwaggerModel.prototype.setReferencedModels = function(allModels) {
      ...
      _results = [];
      this.referencedModels = allModels;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        prop = _ref[_i];
  ...
  SwaggerModelProperty = (function() {
    ...
    SwaggerModelProperty.prototype.toString = function() {
      ...
      var propTypeFormat;
      if(/array/i.test(this.dataTypeWithRef))
        propTypeFormat = "Array of " + this.dataTypeWithRef;
      else
        propTypeFormat = this.dataTypeWithRef;
      /*var baseModel = this.modelObject.allModels[this.refDataType];
      
      if(baseModel)
      {
       debugger;
        var swaggerModel = new SwaggerModel(baseModel.id, baseModel, this.modelObject.allModels);
        propTypeFormat = swaggerModel.getMockSignature([this.refDataType], /array/i.test(this.dataTypeWithRef) );
      }*/
      
      str = '<span class="propName ' + req + '">' + this.name + '</span> (<span class="propType">' + propTypeFormat + '</span>';
      if (!this.required) {
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces) {
      ...
      if (this.type != null) {
        this.responseClassSignature = this.getSignature(this.type, this.resource.models, this.isListType(this.type));
  ...
  SwaggerRequest = (function() {
    ...
    function SwaggerRequest(type, url, params, opts, successCallback, errorCallback, operation, execution) {
      ...
      myHeaders["Content-Type"] = requestContentType || "application/json";
